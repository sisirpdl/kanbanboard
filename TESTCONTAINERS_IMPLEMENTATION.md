...
**Updated `tests\KanbanBoard.FunctionalTests\KanbanBoard.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\KanbanBoard.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\KanbanBoard.FunctionalTests\KanbanBoard.FunctionalTests.csproj
```
