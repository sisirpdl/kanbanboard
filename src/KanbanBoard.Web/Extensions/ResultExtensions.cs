...
namespace KanbanBoard.Web.Extensions;
...
public static class ResultExtensions
{
  ...
  /// <summary>
  /// Maps Result (non-generic) to TypedResults for commands that return Ok, NotFound, ValidationProblem, or ProblemHttpResult
  /// </summary>
  public static Results<Ok, NotFound, ValidationProblem, ProblemHttpResult> ToCommandResult(
    this Result result)
  {
    return result.Status switch
    {
